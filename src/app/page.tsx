...
export default function LandingPage() {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden lg:flex items-center gap-8 text-sm font-semibold">
              ...
              <button
                ...
                className="transition-colors hover:text-[var(--brand-core)]"
                style={{ color: "var(--text-secondary)" }}
              >
                Seller Hub
              </button>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-3.5 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border border-sky-500/30 bg-sky-500/10 text-cyan-400 hover:bg-sky-500/20"
            >
            ...
            <button
              ...
              className="text-sm font-bold px-2 hidden sm:block transition-colors"
              style={{ color: "var(--text-secondary)" }}
            >
              Register
            </button>
            <button
              ...
              className="px-5 py-2 rounded-xl font-bold text-sm hover:opacity-90 transition-all shadow-sm"
              style={{
        ...
        >
          <div className="max-w-4xl mx-auto space-y-4 mb-16">
            ...
            <h2 className="text-3xl sm:text-5xl font-black tracking-tight transition-colors">
              ...
              <span style={{ color: "var(--brand-core)" }}>Three Steps</span>{" "}
              And{" "}
      ...
      {/* ─── FOOTER STRUCTURE ─── */}
      <footer
        className="border-t py-16 px-4 sm:px-6 lg:px-8 transition-colors mt-auto"
        style={{ ...styleElevatedBg, ...styleDefaultBorder }}
      >
